## 아래 블로그에서 가져옴 
## https://data-newbie.tistory.com/247?category=761014
...
class Commad :
    def __init__(self, path = "C:/kafka_2.12-2.4.0/bin/windows/" ) :
    ...
    def create_topic(self, partition , replication , topic) :
        ...
        """
        command = "{}kafka-topics.bat --create --bootstrap-server localhost:9092".format(self.path)
    ...
    def delete_topic(self , topics) :
        ...
        if type(topics) == list :
            ...
            topics = [topics]
        for topic in topics :
            c = "{}kafka-topics.bat --zookeeper localhost:2181 --delete --topic {}".\
    ...
    def delete_Consumer_group(self, group) :
        c = "{}kafka-consumer-groups.bat --zookeeper localhost:2181 --delete --group {}".\
